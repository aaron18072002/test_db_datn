...
( 
    ...
    C03_USER_ID INT NOT NULL,  -- Liên kết trực tiếp với C02_USER_ID
    C03_ENROLLMENT_DATE DATE DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT FK_T03_T02 FOREIGN KEY (C03_USER_ID) REFERENCES T02_USER(C02_USER_ID) ON DELETE CASCADE
);

CREATE TABLE T04_TEACHER (
    C04_TEACHER_ID INT PRIMARY KEY NOT NULL AUTO_INCREMENT,
    C04_USER_ID INT NOT NULL,  -- Liên kết trực tiếp với C02_USER_ID
    C04_HIRE_DATE DATE DEFAULT CURRENT_TIMESTAMP,
    ...
    CONSTRAINT FK_T04_T02 FOREIGN KEY (C04_USER_ID) REFERENCES T02_USER(C02_USER_ID) ON DELETE CASCADE
);
